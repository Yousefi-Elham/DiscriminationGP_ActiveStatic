...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/design.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/design.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/des.seg.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/des.seg.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/des.seg1.jpeg", width=650, height=500)
...
#----------------------
setEPS()
pdf("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/des.seg1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/DesDis.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/DesDis.eps")
...
#--------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/DesDis1.eps", width = 11, height = 7)
...
#####################################################################################################
max(CRIT.vec)
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/criterionval.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi2/random/criterionval.eps")

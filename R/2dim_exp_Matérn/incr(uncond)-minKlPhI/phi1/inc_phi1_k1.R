...
crit.fun.old <- function(theta,sigma2,des){
  ...
  if(n==1){
    ...
    if(det(cov.past.1)==0 | det(cov.past.2)==0){
      ...
      phi.crit <- pred.error.12 - pred.error.11 + pred.error.21 - pred.error.22
    }
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/design.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/design.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/des.seg.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/des.seg.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/des.seg1.jpeg", width=650, height=500)
...
#----------------------
setEPS()
pdf("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/des.seg1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/DesDis.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/DesDis.eps")
...
#--------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/DesDis1.eps", width = 11, height = 7)
...
#####################################################################################################
max(CRIT.vec)
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/criterionval.jpeg")
...
ytick=seq(0,max(CRIT.vec),by=0.01)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/criterionval.eps")
...
#####################################################################################################
max(SCRIT.vec)
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/sumcriterionval.jpeg")
...
xtick=c(seq(1,nrow(xstart),by = 20),nrow(xstart))
ytick=seq(0,max(SCRIT.vec),by=0.5)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi1/sumcriterionval.eps")

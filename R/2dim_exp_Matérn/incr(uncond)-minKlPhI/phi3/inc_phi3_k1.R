...
crit.fun.old <- function(theta,sigma2,des){
  ...
  if(n==1){
    ...
    if(det(cov.past.1)==0 | det(cov.past.2)==0){
      ...
      phi.crit <- 1/2*( pred.error.21/pred.error.11 + pred.error.12/pred.error.22 ) -1
    }
...
SCRIT.vec[1] <- crit.fun(est.theta,sigma2.ini,xstart,kernel1.n,kernel2.n,kernel1.inv,kernel2.inv)
...
for( k in 1: nleft){
  ...
  filter.can.index <- c()    
  for(s in 1:nrow(xcan)){
    test.cand <- rbind(xstart,xcan[s,])
    n <- nrow(test.cand)
    ...
    if(det(kernel1)==0 | det(kernel2)==0) {
      filter.can.index <- c(filter.can.index,s)
    }
  ...
  SCRIT.vec[k+1] <- sum(CRIT.vec[n1:k+n1])
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/design.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/design.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/des.seg.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/des.seg.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/des.seg1.jpeg", width=650, height=500)
...
#----------------------
setEPS()
pdf("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/des.seg1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/DesDis.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/DesDis.eps")
...
#--------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/DesDis1.eps", width = 11, height = 7)
...
#####################################################################################################
max(CRIT.vec)
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/criterionval.jpeg")
...
ytick=seq(0,max(CRIT.vec),by=0.05)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/criterionval.eps")
...
#####################################################################################################
max(SCRIT.vec)
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/sumcriterionval.jpeg")

plot(seq(1:nrow(xstart)),seq(0,max(SCRIT.vec),length=nrow(xstart)),axes = F, type = "n",xlab="Iter",ylab="Criterion value",
     main = bquote( paste("Criterion values for optimum designs",", ", sigma^2, ":",.(sigma2.ini)) ),
     cex.main=2, cex.lab=1.5, cex.axis=1.5,pch=2,col="blue");

xtick=c(seq(1,nrow(xstart),by = 20),nrow(xstart))
ytick=seq(0,max(SCRIT.vec),by=10)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()

lines(seq(1:(nleft+1)),SCRIT.vec,col="blue",lwd = 2)

dev.off()

#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/incr(uncond)-minKlPhI/phi3/sumcriterionval.eps")

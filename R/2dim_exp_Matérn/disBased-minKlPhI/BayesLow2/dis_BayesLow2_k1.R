...
crit.fun.old <- function(theta,sigma2,des){
  ...
  if(n==1){
    ...
    if(det(kernel1)<=0 | det(kernel2)<=0){
      ...
      BayesL.p1 <- -n/2 -1/2*log( 1/2*det(2*kernel1)^(-1/2) + 1/2*det(kernel1+kernel2)^(-1/2) )
      BayesL.p2 <- -1/2*log( 1/2*det(2*kernel2)^(-1/2) + 1/2*det(kernel1+kernel2)^(-1/2) ) -1/4*log(det(kernel1)) -1/4*log(det(kernel2))
...
crit.fun <- function(theta,sigma2,des,cov.past.1,cov.past.2){
  ...
  if(det(kernel1.n)<=0 | det(kernel2.n)<=0){
    ...
    BayesL.p1 <- -n/2 -1/2*log( 1/2*det(2*kernel1.n)^(-1/2) + 1/2*det(kernel1.n+kernel2.n)^(-1/2) )
    BayesL.p2 <-      -1/2*log( 1/2*det(2*kernel2.n)^(-1/2) + 1/2*det(kernel1.n+kernel2.n)^(-1/2) ) -1/4*log(det(kernel1.n)) -1/4*log(det(kernel2.n))
    BayesL <- BayesL.p1 + BayesL.p2
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/design.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/design.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/des.seg.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/des.seg.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/des.seg1.jpeg", width=650, height=500)
...
#----------------------
setEPS()
pdf("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/des.seg1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/DesDis.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/DesDis.eps")
...
#--------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/DesDis1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/criterionval.jpeg")

plot(seq(1:nrow(xstart)),seq(min(CRIT.vec),max(CRIT.vec),length=nrow(xstart)),axes = F, type = "n",xlab="Iter",ylab="Criterion value",
...
ytick=seq(round(min(CRIT.vec),digits=2),round(max(CRIT.vec),digits=2),by=10)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow2/criterionval.eps")

...
#[,1]         [,2]       [,3]
#[1,]  9.699618 0.003175988 0.1671661
#[2,] 10.000000 0.323058137 0.1708291
#[3,]  7.965049 0.858732323 0.1991255
#[4,]  8.050467 0.426470845 0.1428571
#[5,]  9.201003 2.079791682 0.1841489
#[6,]  9.622522 1.967398268 0.1358732
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG501.jpeg")

plot(poi, xlim = c(0,10), ylim = c(0,10),xlab="X1",ylab="X2",cex.main=2, cex.lab=1.5, cex.axis=1.5)
points(des6nlop[,c(1,2)], pch = 1, col = "red", cex = 20*sqrt(des6nlop[,3]))

dev.off()

#-------------------------------------#-------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG501.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG501s.jpeg")

plot(poi, xlim = c(0,10), ylim = c(0,10),xlab="X1",ylab="X2",cex.main=2, cex.lab=1.5, cex.axis=1.5)
points(des6nlop[,c(1,2)], pch = 1, col = "red", cex = 15*sqrt(des6nlop[,3]))

dev.off()

#-------------------------------------#-------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG501s.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG101.jpeg")
...
#-------------------------------------#-------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG101.eps")
...
#-------------------------------------#-------------------------------------
#with smaller scales
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG101s.jpeg")
...
#-------------------------------------#-------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi3/dir.alg501/des6Phi3nloptrU/nofulfillG101s.eps")

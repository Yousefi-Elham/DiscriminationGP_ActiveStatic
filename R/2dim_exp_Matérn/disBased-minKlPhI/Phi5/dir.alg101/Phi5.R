...
dir.deriv <- function(theta,sigma2,des,weight){
  ...
  for(i in 1:N){
    ...
    Phi.crit[i] <- sum(abs(cov.test.opt.1 - cov.test.opt.2)^5*weight) 
...
Phi.optim <- function(theta, sigma2, des, weight) {
  ...
  opt.val <- sum(abs(kernel1 - kernel2)^5*(weight%*%t(weight)))
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi5/dir.alg101/desloc.jpeg")
...
#--------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi5/dir.alg101/desloc.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi5/dir.alg101/nofulfill.jpeg")
...
#--------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi5/dir.alg101/nofulfill.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi5/dir.alg101/nofulfillG5.jpeg")
...
#--------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/Phi5/dir.alg101/nofulfillG5.eps")

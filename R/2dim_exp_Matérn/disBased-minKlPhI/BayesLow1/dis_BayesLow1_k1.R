...
CRIT.vecU <- CRIT.vec <- numeric(nexc)
#--------------------------------------------------------------------------------------
...
crit.fun(est.theta,sigma2.ini,xstart,kernel1.n,kernel2.n,kernel1.inv,kernel2.inv)$BayesL

crit.fun.old(est.theta,sigma2.ini,xstart)$BayesL

CRIT.vec[1:n1] <- crit.fun(est.theta,sigma2.ini,xstart,kernel1.n,kernel2.n,kernel1.inv,kernel2.inv)$BayesL
CRIT.vec[1:n1]
...
system.time({
  ...
  for( k in 1: nleft){
    ...
    for(m in 1: Ncan){
      ...
      ad.crit[m] <- crit.fun(est.theta,sigma2.ini,test.des,kernel1.n,kernel2.n,kernel1.inv,kernel2.inv)$BayesL
      #crit.fun.old(est.theta,sigma2.ini,test.des)$BayesL
    }
    ...
    #CRIT.val <-  crit.fun(est.theta,sigma2.ini,xstart,kernel1.n,kernel2.n,kernel1.inv,kernel2.inv)$BayesL
    ...
    while(!finish.all){
      ...
      for(a in 1: nc1){
        dr.crit[a] <- crit.fun.old(est.theta,sigma2.ini,xstart[-a,])$BayesL
      ...
      for(b in 1: Ncan1){
        ...
        add.crit[b] <- crit.fun(est.theta,sigma2.ini,test.des,kernel1.n.dr,kernel2.n.dr,kernel1.inv.dr,kernel2.inv.dr)$BayesL
        ##crit.fun.old(est.theta,sigma2.ini,test.des)$BayesL
    ...
    CRIT.vec[k+n1] <- crit.fun.old(est.theta,sigma2.ini,xstart)$BayesL
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/design.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/design.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/des.seg.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/des.seg.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/des.seg1.jpeg", width=650, height=500)
...
#----------------------
setEPS()
pdf("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/des.seg1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/DesDis.jpeg")
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/DesDis.eps")
...
#--------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/DesDis1.eps", width = 11, height = 7)
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/criterionval.jpeg")

plot(seq(1:nrow(xstart)),seq(0,0.7,length=nrow(xstart)),axes = F, type = "n",xlab="Iter",ylab="Criterion value",
     cex.main=2, cex.lab=1.5, cex.axis=1.5,pch=2,col="blue");

xtick=c(seq(1,nrow(xstart),by = 40),nrow(xstart))
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/criterionval.eps")
...
#----------------------------------------------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/criterionval2.jpeg")
...
lines(seq(1:nrow(xstart)),CRIT.vec,col="blue",lwd = 2)
lines(seq(1:nrow(xstart)),CRIT.vecU,col="red",lwd = 2)

legend("topleft",legend=c("Bayesian Lower bound","Bayesian Upper bound"),lwd=c(2,2),col=c("blue","red"),bty="n",cex=1.5) 
...
#----------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/disBased-minKlPhI/BayesLow1/criterionval2.eps")

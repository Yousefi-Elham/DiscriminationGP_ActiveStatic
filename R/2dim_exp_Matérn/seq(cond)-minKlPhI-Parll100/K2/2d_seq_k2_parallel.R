...
NRUN <- 100 # number of random runs
...
sequential.run <- function(NN) {
  ...
  y.obs.K <- generate.y.kernels(THETA.FIX[2],sigma2.ini,xstart,1)$y
  ...
  for( k in 1: nleft){
    ...
    y.obs.K <- generate.y.kernels.cond(THETA.FIX[2],sigma2.ini,xstart,y.obs.K,1)$y #true pars so fix, only model changes
...
#--------------------------------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/ranRunRep.jpeg")
...
#------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/ranRunRep.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/ranRun.jpeg")
...
#--------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/ranRun.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/histogram.jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/histogram.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/plotparest1.jpeg")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/plotparest2.jpeg")
...
#-----------------------------
#-----------------------------#-----------------------------#-----------------------------#-----------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxparest1.jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxparest1.eps")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxparest1cut.eps")
...
dev.off()
#-----------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/mlest1.jpeg")

par(mgp=c(2.5, 1, 0)) 
par(mar = c(5, 5, 4, 2) + 0.1)

y_expression <- expression(Parameter ~ estimate ~ hat(theta[0]) )

boxplot(t(THETA1.EST),axes=F ,ylim=c(0,6), cex.main=2, cex.lab=1.5, cex.axis=1.5,
        xlab="Iteration", ylab=y_expression)
abline(h=THETA.FIX[1],lty=2,col="red") #true par of true model
#xtick=c(1,10,20,30,40,50)
xtick=seq(1,nleft,length.out = 6)
ytick=seq(0,max(THETA1.EST,THETA2.EST),by=1)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/mlest1.eps")
...
dev.off()
#-----------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxparest2.jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxparest2.eps")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxparest2cut.eps")
...
dev.off()
#-----------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/mlest2.jpeg")

par(mgp=c(2.5, 1, 0)) 
par(mar = c(5, 5, 4, 2) + 0.1)

y_expression <- expression(Parameter ~ estimate ~ hat(theta[1]) )
...
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/mlest2.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/plotmineig1.jpeg")
...
#abline(h=THETA.FIX[2],lty=2,col="red") #true par of true model
xtick=seq(1,nleft,by=2)
ytick=seq(0,max(MIN.EIG.K1H),by=300)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/plotmineig2.jpeg")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxmineig1.jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxmineig1.eps")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxmineig1(cut).eps")
...
dev.off()
#-----------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxmineig2.jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxmineig2.eps")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxmineig2(cut).eps")

boxplot(t(MIN.EIG.K2H),axes=F ,ylim=c(0,600), cex.main=2, cex.lab=1.5, cex.axis=1.5,
        xlab="Iteration", ylab="Inverse minimum eigen values of K1")
xtick=c(seq(1,nleft,by=2),nleft)
ytick=seq(0,600,by=200)
axis(1,at=xtick,labels=T,cex.axis=1.5)
axis(2,at=ytick,labels=T,cex.axis=1.5)
box()
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/criterionval.jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/criterionval.eps")
...
#-----------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/criterionval(cut).jpeg")
...
#-----------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/criterionval(cut).eps")
...
#------------------------
max(CRIT.MAT)
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxplot.jpeg")
...
#----------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxplot.eps")
...
dev.off()
#------------------------
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxplot(cut).jpeg")
...
#----------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxplot(cut2).eps")
...
#----------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/boxplot(cut3).eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/DesDis1.jpeg")
...
##---------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/DesDis1.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/DesDis2.jpeg")
...
##---------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/DesDis2.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/DesDis0.jpeg")
...
##---------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/DesDis0.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/onefindesDis1.jpeg")
...
#-----------------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/onefindesDis1.eps")
...
jpeg("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/onefindesDis2.jpeg")
...
#-----------------------------------------------------------------------
setEPS()
postscript("G:/Other computers/My Computer/3files/2022/2-Feb/GP-project-R/Matern1.5-2.5-newpar/2dim_exp/seq(cond)-minKlPhI-Parll100/K2/onefindesDis2.eps")
